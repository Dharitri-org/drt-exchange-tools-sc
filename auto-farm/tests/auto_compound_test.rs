...
//     farm_setup.b_mock.borrow_mut().set_dct_balance(
...
//             expected_fees
//                 .other_tokens
//                 .add_payment(DctTokenPayment::new(
...
//             expected_fees.opt_locked_tokens = Some(DctTokenPayment::new(
...
//             expected_user_rewards.opt_locked_tokens = Some(DctTokenPayment::new(
//                 managed_token_id!(LOCKED_TOKEN_ID),
//                 1,
...
//             let expected_farm_staking_tokens = ManagedVec::from_single_item(DctTokenPayment::new(
