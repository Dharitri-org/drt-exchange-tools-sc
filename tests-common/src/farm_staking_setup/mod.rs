...
use dharitri_sc::types::{DctLocalRole, ManagedAddress, MultiValueEncoded};

use dharitri_sc_scenario::testing_framework::{BlockchainStateWrapper, ContractObjWrapper};
use dharitri_sc_scenario::{managed_biguint, managed_token_id, rust_biguint, DebugApi};
    ...
    FarmObjBuilder: 'static + Copy + Fn() -> farm_staking::ContractObj<DebugApi>,
{
    ...
    b_mock.set_dct_balance(&owner_addr, reward_token_id, &TOTAL_REWARDS_AMOUNT.into());
    b_mock
