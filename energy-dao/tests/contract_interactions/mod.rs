...
use dharitri_sc::{
    ...
    types::{Address, DctTokenPayment, MultiValueEncoded},
};
    ...
    FarmStakingProxyObjBuilder: 'static + Copy + Fn() -> farm_staking_proxy::ContractObj<DebugApi>,
{
    ...
    pub fn call_pair_add_liquidity(
        ...
        self.b_mock
            .execute_dct_multi_transfer(caller, &self.pair_wrapper, &payments, |sc| {
    ...
    pub fn enter_original_farm_endpoint(
        ...
        self.b_mock
            .execute_dct_transfer(
                ...
                &rust_biguint!(payment_amount),
                |sc| {
                    sc.enter_farm_endpoint(dharitri_sc::codec::multi_types::OptionalValue::None);
                },
            )
            .assert_ok();
    }
        ...
        self.b_mock
            .execute_dct_transfer(
                ...
                |sc| {
                    ...
                    let new_expected_payment = DctTokenPayment::new(
    ...
    pub fn setup_new_user(&mut self, token_id: &[u8], token_amount: u64) -> Address {
        ...
        self.b_mock
            .set_dct_balance(&new_user, token_id, &rust_biguint!(token_amount));
        new_user
    }
}
