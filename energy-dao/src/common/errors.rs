...
pub static ERROR_LP_FARM_METASTAKING_ACTIVE: &[u8] = b"The farm has active Metastaking";
pub static ERROR_METASTAKING_DOES_NOT_EXIST: &[u8] = b"Metastaking does not exist";
pub static ERROR_METASTAKING_ALREADY_DEFINED: &[u8] = b"Metastaking already defined";
pub static ERROR_METASTAKING_HAS_FUNDS: &[u8] = b"Metastaking has user funds";
...
pub static ERROR_PERCENTAGE_VALUE: &[u8] = b"Incorrect percentage";
pub static ERROR_EXTERNAL_CONTRACT_OUTPUT: &[u8] = b"Invalid external contract output";
pub static ERROR_LOCKED_TOKENS_NOT_FOUND: &[u8] = b"Locked tokens not found";
