    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    ...
    fn call_exit_metastaking(
        &self,
        metastaking_address: ManagedAddress,
        full_dual_yield_position: DctTokenPayment,
        ...
        self.metastaking_proxy(metastaking_address)
            ...
            .with_dct_transfer(full_dual_yield_position)
            .execute_on_dest_context()
    }
    ...
    fn call_unbond_metastaking(
        &self,
        metastaking_address: ManagedAddress,
        unbond_position: DctTokenPayment,
        ...
        self.farm_staking_proxy(staking_farm_address)
            .unbond_farm()
            .with_dct_transfer(unbond_position)
            .execute_on_dest_context()
    }
    ...
    fn update_metastaking_after_claim(
        ...
        new_dual_yield_token: &DctTokenPayment,
        lp_farm_rewards: DctTokenPayment,
        staking_rewards: DctTokenPayment,
        ...
        let new_lp_farm_rewards = if initial_metastaking_state.lp_farm_reward_reserve > 0 {
            ...
            let current_farm_rewards = DctTokenPayment::new(
