...
pub trait LockedTokenModule: energy_query::EnergyQueryModule {
    fn lock_tokens(&self, payment: DctTokenPayment, epoch: Epoch) -> DctTokenPayment {
    ...
    fn merge_locked_tokens(&self, locked_tokens: PaymentsVec<Self::Api>) -> DctTokenPayment {
    ...
    fn wrap_locked_token(&self, payment: DctTokenPayment<Self::Api>) -> DctTokenPayment {
