...
pub trait RouterActionsModule {
    fn multi_pair_swap(
        &self,
        start_payment: DctTokenPayment<Self::Api>,
        ...
        let mut last_payment = MoaxOrDctTokenPayment::from(start_payment.clone());
        ...
        loop {
            ...
            last_payment.token_identifier = MoaxOrDctTokenIdentifier::dct(token_wanted);
        ...
        let ((), back_transfers) = self
            ...
            .with_dct_transfer(start_payment)
