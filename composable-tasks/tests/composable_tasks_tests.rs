...
use dharitri_sc::types::{
    MoaxOrDctTokenIdentifier, MoaxOrDctTokenPayment, ManagedVec, MultiValueEncoded,
};
use dharitri_sc_scenario::*;
use wmoax_swap_setup::WMOAX_TOKEN_ID;

pub mod composable_tasks_setup;
pub mod pair_setup;
pub mod wmoax_swap_setup;
...
fn full_composable_tasks_setup_test() {
    let _ = ComposableTasksSetup::new(
        pair::contract_obj,
        router::contract_obj,
        dharitri_wmoax_swap_sc::contract_obj,
...
fn unwrap_single_task_test() {
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                tasks.push((TaskType::UnwrapMOAX, no_args).into());

                let expected_token_out = MoaxOrDctTokenPayment::new(
    ...
    b_mock
        .borrow_mut()
        .check_moax_balance(&first_user_addr, &rust_biguint!(user_first_token_balance));
}
...
fn unwrap_send_test() {
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                tasks.push((TaskType::UnwrapMOAX, no_args).into());
                tasks.push((TaskType::SendMoaxOrDct, send_args).into());
    ...
    b_mock
        .borrow_mut()
        .check_moax_balance(&second_user_addr, &rust_biguint!(user_first_token_balance));
}
...
fn wrap_send_test() {
    ...
    b_mock
        .borrow_mut()
        .set_moax_balance(&first_user_addr, &rust_biguint!(user_first_token_balance));
    ...
    b_mock
        ...
        .execute_tx(
            ...
            |sc| {
                ...
                tasks.push((TaskType::WrapMOAX, no_args).into());
                tasks.push((TaskType::SendMoaxOrDct, send_args).into());

                let expected_token_out = MoaxOrDctTokenPayment::new(
                    MoaxOrDctTokenIdentifier::dct(WMOAX_TOKEN_ID),
                    0,
                    managed_biguint!(user_first_token_balance),
                );
    ...
    // Funds are sent to the destination
    b_mock.borrow_mut().check_dct_balance(
        &second_user_addr,
        WMOAX_TOKEN_ID,
        &rust_biguint!(user_first_token_balance),
    );
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                let expected_token_out = MoaxOrDctTokenPayment::new(
                    MoaxOrDctTokenIdentifier::dct(TOKEN_IDS[0]),
                    0,
...
fn swap_send_test() {
    ...
    b_mock
        .borrow_mut()
        .check_dct_balance(&first_user_addr, TOKEN_IDS[0], &rust_biguint!(0));
}
...
fn swap_unwrap_test() {
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                tasks.push((TaskType::Swap, swap_args).into());
                tasks.push((TaskType::UnwrapMOAX, ManagedVec::new()).into());
    ...
    b_mock
        .borrow_mut()
        .check_moax_balance(&first_user_addr, &rust_biguint!(expected_balance));
}
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                tasks.push((TaskType::WrapMOAX, ManagedVec::new()).into());

                let expected_token_out = MoaxOrDctTokenPayment::new(
                    MoaxOrDctTokenIdentifier::dct(managed_token_id!(WMOAX_TOKEN_ID)),
                    0,
                    managed_biguint!(user_first_token_balance),
                );
        ...
        .assert_error(4, "Payment token is not MOAX!");
...
fn swap_unwrap_wrap_send_test() {
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                let mut swap_args = ManagedVec::new();
                swap_args.push(managed_buffer!(WMOAX_TOKEN_ID));
                swap_args.push(managed_buffer!(b"1"));
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                let expected_token_out = MoaxOrDctTokenPayment::new(
                    MoaxOrDctTokenIdentifier::dct(managed_token_id!(TOKEN_IDS[0])),
                    0,
                    managed_biguint!(expected_balance),
                );
    ...
    b_mock
        ...
        .execute_dct_transfer(
            ...
            |sc| {
                ...
                tasks.push((TaskType::RouterSwap, swap_args).into());
                let expected_token_out = MoaxOrDctTokenPayment::new(
                    MoaxOrDctTokenIdentifier::dct(managed_token_id!(TOKEN_IDS[1])),
                    0,
