...
use dharitri_sc::types::{
    BigUint, DctLocalRole, DctTokenPayment, ManagedBuffer, MultiValueEncoded,
};
    ...
    b_mock
        ...
        .execute_dct_multi_transfer(
            ...
            |sc| {
                ...
                // wmoax_leftover and locked_token_leftover are 0 so output_payments has only 1 element
    ...
    b_mock
        ...
        .execute_dct_multi_transfer(
            ...
            |sc| {
                ...
                // wmoax_leftover, locked_token_leftover and boosted rewards are 0
