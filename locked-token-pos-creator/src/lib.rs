...
pub trait LockedTokenPosCreatorContract:
    ...
    + auto_pos_creator::external_sc_interactions::moax_wrapper_actions::MoaxWrapperActionsModule
    ...
    + auto_pos_creator::external_sc_interactions::metastaking_actions::MetastakingActionsModule
{
    ...
    fn init(
        ...
        mex_wmoax_lp_pair_address: ManagedAddress,
        ...
        self.require_sc_address(&mex_wmoax_lp_pair_address);
        ...
        self.pair_address().set(mex_wmoax_lp_pair_address);
