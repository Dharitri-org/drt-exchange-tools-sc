    ...
    + crate::external_sc_interactions::energy_factory_actions::EnergyFactoryActionsModule
{
    fn prepare_locked_payments(
        ...
        first_token_payment: DctTokenPayment,
        second_token_payment: DctTokenPayment,
    ) -> (DctTokenPayment, DctTokenPayment) {
    ...
    fn create_locked_lp_pos(
        ...
        output_payments.push(add_liq_result.wmoax_leftover);
